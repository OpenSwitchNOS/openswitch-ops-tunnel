...
/* Help strings */
#define VLAN_NUM_HELP_STR                   "vlan range\n"
...
#define TUNNEL_VXLAN_PORT_NUM_HELP_STR      "udp-port range\n"
#define TUNNEL_VXLAN_VNI_LIST_STR           "Set the vni for an interface\n"
#define TUNNEL_VXLAN_VNI_LIST_NUM_HELP_STR  "VNI range\n"
...
#define TUNNEL_LOOPBACK_IF_NUM_HELP_STR     "Loopback interface range\n"
